...
export const PRESETS = [
  ...
  { label: "Gmail → Slack daily digest", prompt: "Read my 2 most recent unread Gmail messages, summarize each one in a single sentence, then post the digest as a single formatted Slack message to my #daily-updates channel" },
