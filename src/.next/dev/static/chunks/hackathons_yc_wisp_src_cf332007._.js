...
function WorkflowPage() {
    ...
    const handleConvertToWorkflow = (0, __TURBOPACK__imported__module__$5b$project$5d2f$hackathons$2f$yc$2f$wisp$2f$src$2f$node_modules$2f2e$pnpm$2f$next$40$16$2e$1$2e$1_react$2d$dom$40$19$2e$2$2e$3_react$40$19$2e$2$2e$3_$5f$react$40$19$2e$2$2e$3$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "WorkflowPage.useCallback[handleConvertToWorkflow]": async ()=>{
            if (executedSteps.length === 0) return;
            try {
                const res = await fetch(`${__TURBOPACK__imported__module__$5b$project$5d2f$hackathons$2f$yc$2f$wisp$2f$src$2f$components$2f$workflow$2d$ui$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["API"]}/convert-to-workflow`, {
                    method: "POST",
                    headers: {
                        "Content-Type": "application/json"
                    },
    ...
    }["WorkflowPage.useCallback[handleConvertToWorkflow]"], [
        executedSteps,
        agentSummary,
        router
    ]);
...
_s(WorkflowPage, "vK53ZzUhS8OoRQHoPNcSndoWDOI=", false, function() {
    return [
