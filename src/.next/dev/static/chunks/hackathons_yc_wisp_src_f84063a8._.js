...
function CredentialsPane() {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$hackathons$2f$yc$2f$wisp$2f$src$2f$node_modules$2f2e$pnpm$2f$next$40$16$2e$1$2e$1_react$2d$dom$40$19$2e$2$2e$3_react$40$19$2e$2$2e$3_$5f$react$40$19$2e$2$2e$3$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "CredentialsPane.useEffect": ()=>{
            fetch(`${__TURBOPACK__imported__module__$5b$project$5d2f$hackathons$2f$yc$2f$wisp$2f$src$2f$components$2f$workflow$2d$ui$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["API"]}/credentials/profiles`).then({
                "CredentialsPane.useEffect": (r)=>r.json()
            }["CredentialsPane.useEffect"]).then({
                "CredentialsPane.useEffect": (d)=>setProfiles(d.profiles ?? [])
            }["CredentialsPane.useEffect"]).catch({
                "CredentialsPane.useEffect": ()=>{}
            }["CredentialsPane.useEffect"]).finally({
                "CredentialsPane.useEffect": ()=>setLoading(false)
            }["CredentialsPane.useEffect"]);
        }
    }["CredentialsPane.useEffect"], []);
    const resetForm = ()=>{
    ...
    const handleSave = async ()=>{
        ...
        setSaving(true);
        try {
            await fetch(`${__TURBOPACK__imported__module__$5b$project$5d2f$hackathons$2f$yc$2f$wisp$2f$src$2f$components$2f$workflow$2d$ui$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["API"]}/credentials/profiles/${encodeURIComponent(appId)}`, {
                method: "PUT",
                headers: {
            ...
            const refreshed = await fetch(`${__TURBOPACK__imported__module__$5b$project$5d2f$hackathons$2f$yc$2f$wisp$2f$src$2f$components$2f$workflow$2d$ui$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["API"]}/credentials/profiles`).then((r)=>r.json());
...
_s2(CredentialsPane, "iiredpMWEcCBsbss7I0GYekB+RI=");
_c9 = CredentialsPane;
// ─── Marketplace ─────────────────────────────────────────────────────────────
...
_s3(Dashboard, "dcRIrIX4nO6OK8HfV7dfiyH+OSE=");
_c11 = Dashboard;
...
__turbopack_context__.k.register(_c9, "CredentialsPane");
__turbopack_context__.k.register(_c10, "MarketplacePane");
__turbopack_context__.k.register(_c11, "Dashboard");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
